...
import explan.model.IExtendedExperimentService;
import explan.model.OCCPExperimentService;
import explan.view.Lab4View;
import javafx.fxml.FXML;
import javafx.scene.control.CheckBox;
import javafx.scene.control.TextField;

public class Lab4Controller extends Lab4View {

    ExtendedSimulationService simulationService = new ExtendedSimulationService();
    IExtendedExperimentService experimentService = new OCCPExperimentService();
